...
logging.basicConfig(filename=f"../inputs_outputs/videos/gc_tag/labels_csv/logs/vjump_dataset_validation_{timestr}.txt", filemode='a', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s', datefmt='%d-%b-%y %H:%M:%S')
